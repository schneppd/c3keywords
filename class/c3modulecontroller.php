...
include_once(dirname(__FILE__) . '/c3modulemodel.php');
/*
 * Basic c3 module logic 
 */

// common module logic
class C3ModuleController {
	protected $model;
	protected $nameModule;
	protected $pathModule;

	public function __construct($name) {
		$this->model = new C3ModuleModel();
		$this->nameModule = $name;
	}
	
	public function setupDatabaseInformations($db, $dbPrefix, $useSqlSlave){
		$this->model->setDatabaseInformations($db, $dbPrefix, $useSqlSlave);
	}
